...
The npm package **`runjucks`** wraps this crate via NAPI for Node.js. Rust-only users depend on this crate from [crates.io](https://crates.io/crates/runjucks_core).
